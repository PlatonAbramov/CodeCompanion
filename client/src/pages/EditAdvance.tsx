...
export default function EditAdvance() {
  ...
  const { mutate: updateAdvance, isPending } = useMutation({
    ...
    onSuccess: () => {
      toast({
        title: "Аванс обновлен",
        description: "Аванс успешно обновлен",
      });
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-white shadow-sm border-b border-slate-200 sticky top-0 z-40">
        <div className="px-4 py-3">
          <div className="flex items-center">
            ...
            <h2 className="font-semibold text-slate-900">Редактировать аванс</h2>
          </div>
        </div>
      </header>
      ...
      <div className="p-4 pb-20">
        <Card className="shadow-sm">
          <CardHeader>
            <CardTitle>Редактирование аванса</CardTitle>
          </CardHeader>
          <CardContent>
